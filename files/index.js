...
const UUID = process.env.UUID || 'c7c23cda-1536-4d7c-ad03-a3eb4ea64579'; //若需要改UUID，需要在config.json里改为一致
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nz.cl888.dpdns.org:8008';     
